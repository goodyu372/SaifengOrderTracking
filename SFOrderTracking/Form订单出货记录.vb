Public Class Form订单出货记录
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        For i = 0 To DataGridView2.Rows.Count - 1
            ...
            Else
                rs.MoveFirst()
                TotalOutput = rs.Fields("TotalOutput").Value
            End If
            ...
            rs.MoveFirst()
            If TotalOutput >= rs.Fields("Qty").Value Then
                rs.Fields("Status").Value = "完成入库"
            Else
                rs.Fields("Status").Value = "部分入库"
            End If
            rs.Update()
            rs.Close()
        Next
    ...
    Private Sub Form49_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        DataGridView2.Columns.Add("Qty", "出货数量")
    ...
    Private Sub TextBox1_KeyDown(sender As Object, e As KeyEventArgs) Handles TextBox1.KeyDown
        If e.KeyCode = 13 Then
            ...
            SQLstring = "Select ID,CustOrder,CustCode,SFOrder,DrawNo,PartName,Qty,UnitP,TotalOut from TotalOutput where SFOrder=" & "'" & TextBox1.Text & "' and TotalOut<Qty"
            cn.Open(CNsfmdb)
            rs.Open(SQLstring, cn, 1, 1)
            If rs.RecordCount = 0 Then
                rs.Close()
    ...
    Private Sub DataGridView1_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellDoubleClick
        ...
        For i = 0 To DataGridView2.Columns.Count - 1
            ...
            DataGridView2.Item("Qty", DataGridView2.Rows.Count - 1).Value = DataGridView1.Item("Qty", e.RowIndex).Value - DataGridView1.Item("TotalOut", e.RowIndex).Value
        Next
    ...
    Private Sub TextBox2_KeyDown(sender As Object, e As KeyEventArgs) Handles TextBox2.KeyDown
        If e.KeyCode = 13 Then
            ...
            SQLstring = "Select ID,CustOrder,CustCode,SFOrder,DrawNo,PartName,Qty,UnitP,TotalOut from TotalOutput where DrawNo like " & "'%" & TextBox2.Text & "%' and TotalOut<Qty"
            cn.Open(CNsfmdb)
            rs.Open(SQLstring, cn, 1, 1)
            If rs.RecordCount = 0 Then
                rs.Close()
    ...
    Private Sub TextBox3_KeyDown(sender As Object, e As KeyEventArgs) Handles TextBox3.KeyDown
        If e.KeyCode = 13 Then
            ...
            SQLstring = "Select ID,CustOrder,CustCode,SFOrder,DrawNo,PartName,Qty,UnitP,TotalOut from TotalOutput where CustOrder like " & "'%" & TextBox3.Text & "%' and TotalOut<Qty"
            cn.Open(CNsfmdb)
            rs.Open(SQLstring, cn, 1, 1)
            If rs.RecordCount = 0 Then
                rs.Close()
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        For i = 0 To DataGridView1.Rows.Count - 1
            ...
            For j = 0 To DataGridView2.Columns.Count - 1
                ...
                DataGridView2.Item("Qty", DataGridView2.Rows.Count - 1).Value = DataGridView1.Item("Qty", i).Value - DataGridView1.Item("TotalOut", i).Value
            Next
        Next
    End Sub
