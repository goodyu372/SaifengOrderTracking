Public Class Form按图号查询未完成零件
    Private Sub TextBox1_KeyDown(sender As Object, e As KeyEventArgs) Handles TextBox1.KeyDown
        If (e.KeyCode = 13) Then
            ...
            SQLstring = "Select * from SFOrderBase where DrawNo like " & "'%" & TextBox1.Text & "%'"
            cn.Open(CNsfmdb)
    ...
    Private Sub DataGridView1_CellContentDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellContentDoubleClick
        ...
        End If
    End Sub
    Private Sub Form18_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Form订单查询.Show()
    End Sub
    Private Sub Form18_Resize(sender As Object, e As EventArgs) Handles Me.Resize
