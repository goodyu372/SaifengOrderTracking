Public Class Form补充出货价格
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        For i = 2 To xlsheet.UsedRange.Rows.Count
            ...
            Else
                SQLstring = "Select * From OutputRecord where DrawNo=" & "'" & xlsheet.Cells(i, 1).value & "'" & " and CustCode=" & "'" & TextBox1.Text & "'"
        ...
        MsgBox("Price input for output record completed !")

    End Sub

    Private Sub Form64_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Form主窗体.Show()
    End Sub
End Class