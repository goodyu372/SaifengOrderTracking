Public Class Form根据材料信息查图号
    ...
    Private Sub TextBox8_KeyDown(sender As Object, e As KeyEventArgs) Handles TextBox8.KeyDown
        If e.KeyCode = 13 Then
            ...
            cn.Open(CNsfmdb)
            SQLstring = "Select DWGInfo,SFOrder,DrawNo,ProcDesc From ProcCard where ProcName='下料' and ProcDesc like " & "'%" & TextBox8.Text & "%'"
    ...
    Private Sub Form65_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        DataGridView1.Columns.Add("ProcDesc", "下料信息")
